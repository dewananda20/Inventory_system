<div id="create-category-modal" tabindex="-1" class="fixed inset-0 z-50 hidden w-full h-full overflow-y-auto">
    <div class="relative w-full h-full max-w-md m-auto flex items-center justify-center">
        <div class="bg-white rounded-lg shadow-lg p-6 w-full">
            <div class="flex justify-between items-center pb-3 border-b">
                ...
                <button type="button" class="text-gray-400 hover:text-gray-500" onclick="closeModal('create-category-modal')">
                    <i class="bi bi-x"></i>
                </button>
            </div>
